...
CESM work notes: How to change CO2 in fully-coupled CESM2
===============
[//]:# (B1850 case)
[//]:# (B1PCT case)
[//]:# (BCO2x4 case)
...
------------
Understand basic variables specified in *env_run.xml* and *user_nl_clm*. Users are suggested to change variables ONLY in *user_nl_clm*.
